...
REG_ZERO_2A             = $2a
REG_ZERO_52             = $52
REG_ZERO_FB             = $fb                ; reserve for music player
REG_ZERO_FC             = $fc                ; reserve for music player
REG_ZERO_FD             = $fd                ; reserve for music player
REG_ZERO_FE             = $fe                ; reserve for music player
...
REG_SPRITE_DATA_PTR_0   = $07f8              ; sprite data pointer address start
REG_SPRITE_X_0          = $d000              ; sprite 0 x position
REG_SPRITE_Y_0          = $d001              ; sprite 0 y position
REG_SPRITE_X_1          = $d002              ; sprite 1 x position
REG_SPRITE_Y_1          = $d003              ; sprite 1 y position
REG_SPRITE_X_2          = $d004              ; sprite 2 x position
REG_SPRITE_Y_2          = $d005              ; sprite 2 y position
REG_SPRITE_X_3          = $d006              ; sprite 3 x position
REG_SPRITE_Y_3          = $d007              ; sprite 3 y position
REG_SPRITE_X_4          = $d008              ; sprite 4 x position
REG_SPRITE_Y_4          = $d009              ; sprite 4 y position
REG_SPRITE_X_5          = $d00a              ; sprite 5 x position
REG_SPRITE_Y_5          = $d00b              ; sprite 5 y position
REG_SPRITE_X_6          = $d00c              ; sprite 6 x position
REG_SPRITE_Y_6          = $d00d              ; sprite 6 y position
REG_SPRITE_X_7          = $d00e              ; sprite 7 x position
REG_SPRITE_Y_7          = $d00f              ; sprite 7 y position
REG_SPRITE_X_MSB        = $d010              ; sprite 0-7 X position bit 8
REG_SCREENCTL_1         = $d011              ; screen control register #1
REG_RASTERLINE          = $d012              ; raster line position 
REG_SPRITE_ENABLE       = $d015              ; enable sprites
...
REG_SPRITE_MULTICOLOUR  = $d01c              ; sprite multicolour enable
REG_SPRITE_D_WIDTH      = $d01d              ; double width sprites
REG_BORCOLOUR           = $d020              ; border colour register
REG_BGCOLOUR            = $d021              ; background colour register
REG_SPRITE_MC_1         = $d025              ; extra sprite colour 1
REG_SPRITE_MC_2         = $d026              ; extra sprite colour 2
REG_SPRITE_COLOUR_0     = $d027              ; sprite 0 colour
REG_SPRITE_COLOUR_1     = $d028              ; sprite 1 colour
REG_SPRITE_COLOUR_2     = $d029              ; sprite 2 colour
REG_SPRITE_COLOUR_3     = $d02a              ; sprite 3 colour
REG_SPRITE_COLOUR_4     = $d02b              ; sprite 4 colour
REG_SPRITE_COLOUR_5     = $d02c              ; sprite 5 colour
REG_SPRITE_COLOUR_6     = $d02d              ; sprite 6 colour
REG_SPRITE_COLOUR_7     = $d02e              ; sprite 7 colour
...
C_SCREEN_BANK_0         = $0400              ; screen RAM
C_DYCP_HIGH_ROW         = $05b8              ; screen RAM - dycp row 1
C_DYCP_LOW_ROW          = $05e0              ; screen RAM - dycp row 2
C_SPRITE_PTRS_BANK_3    = $07f8              ; location of sprite pointers in bank 3
C_MUSIC_LOCATION        = $1000              ; location of music
C_MUSIC_INIT            = $1000              ; music init routine
C_MUSIC_PLAY            = $1003              ; music player routine
C_SPRITES_BANK_3        = $2000              ; start of sprite data location
C_CHARSET               = $3000              ; storage for character set
C_SCREEN_RAM_BANK_2     = $4400              ; screen memory in VIC bank 2
C_SPRITE_PTRS_BANK_2    = $47f8              ; location of sprite pointers in bank 2
C_SPRITES_BANK_2        = $6000              ; storage for sprites in VIC bank 2
C_INFLATE_CACHE         = $6d00              ; storage for data inflation at startup
C_TEMPORARY_DATA        = $c000
C_SCROLLER_BAR_COLOURS  = $c000              ; scroller raster bar colours
C_SCROLL_TRANS_INDEX    = $c0d0              ; scroller transition in step index
C_TEXT_GLOW_SEQUENCE    = $c0e0              ; credit text colout sequence
C_ANIM_BAR_TABLE        = $c100              ; animated raster bar render target
C_ANIM_SCROLL_TABLE     = $c120              ; animates raster bar scroll offset table
C_ANIM_BAR_COLOURS      = $c140              ; colours used in animated raster bars
C_ANIM_BAR_TRAN_INDEX   = $c200              ; transition in index for animated raster bars
C_SCROLL_SINE_INDEX     = $c201              ; scroller height sine index
C_SCROLL_MESSAGE_INDEX  = $c202              ; scroller character index
C_TEXT_WAVE_SINE_INDEX  = $c203              ; text wave sine index
C_SPRITE_SPLIT_INDEX    = $c205              ; intro transition sprite split index (1 byte)
C_INTRO_CLEAR_COUNTER   = $c206              ; intro transition sprite row counter (1 byte)
C_SPLIT_INDEX           = $c207              ; final intro transition split index (1 byte)
C_SPLIT_SEQUENCE_INDEX  = $c208              ; final intro transition seq index (7 bytes)
C_SPLIT_SEQUENCE_ACTIVE = $c20f              ; final intro transition active seq index (7 bytes)
C_SMOOTHING_1           = $c217              ; smoothing counter (1 byte)
C_SCROLL_BUFFER_LOW     = $c240              ; scroller source char low byte table (40 bytes)
C_SCROLL_BUFFER_HIGH    = $c280              ; scroller source char high byte table (40 bytes)
C_SCROLL_BUFFER_HEIGHT  = $c2d2              ; scroller height table (40 bytes)
C_LOGO_COLOURS          = $c300              ; logo colour table
C_LOGO_COL_INDEX_1      = $c340              ; first logo colour index
C_LOGO_COL_INDEX_2      = $c341              ; second logo colour index
C_LOGO_TRANS_STEP       = $c342              ; logo transition step (0 - 2)
C_LOGO_TRANS_ACTIVE     = $c343              ; logo transition is active
C_LOGO_TRANS_DELAY      = $c344              ; delay between logo transitions
C_SCROLLER_ACTIVE       = $c345              ; text scroller active
C_TEXT_BARS_ACTIVE      = $c346              ; animated text bars active
C_SCROLL_MESSAGE        = $c400              ; scroller message
C_COLOUR_RAM            = $d800              ; colour ram
...
display_text_c          !byte 096, 096, 067, 069, 078, 083, 079, 082, 108, 096, 072, 079, 075, 085, 084, 079
